...
mindmap
  root((Core<br/>Competencies))
    Technical Team Management
      ...
      Staffing Plans & Resource Forecasting
      Interviewing, Hiring & Training
      Performance Evaluation & Coaching
    People Strategy & Communication
      Employee Development & Retention
      Mentorship & Cross-Training Programs
      Internal & External Teamwork Facilitation
      Sr. Leadership Liaison & Information Flow
    Strategic & Financial Oversight
      Budget Proposals & Financial Management
      Equipment & Resource Requirements
      Business Process Improvement
      Quality Metrics & Total Quality Assurance
    Mission Execution & Innovation
      Vision & Strategy for Mission Objectives
      Full Program Lifecycle Management
      Improving Quality, Flowtime & Productivity
      Operational Surety & Risk Mitigation
```
...
flowchart TB
    subgraph "10 Years of Service"
        A["E5 Sergeant<br/>May 2011"] --> B["BMET Certification<br/>Distinguished Honor Graduate<br/>Aug 2012"]
...
```mermaid
flowchart TB
    subgraph MGT["Technical Management & Leadership"]
